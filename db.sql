...
--
-- Структура таблицы `forecast_sended`
--

CREATE TABLE `forecast_sended` (
  `id` int(11) NOT NULL,
...
--
-- Индексы таблицы `forecast_sended`
--
ALTER TABLE `forecast_sended`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `capper`
--
ALTER TABLE `capper`
...
--
-- AUTO_INCREMENT для таблицы `forecast_sended`
--
ALTER TABLE `forecast_sended`
